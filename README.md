...
Weibo:[@œ€ ¿_À§µπµƒ–°”„](http://weibo.com/2360273757)
...
When the width of CarouselView is larger than ItemWidth the items' width is equal to ItemWidth, while itemitems' width is equal to the width of CarouselView.
